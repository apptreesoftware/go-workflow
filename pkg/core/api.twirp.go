...
type WorkflowAPI interface {
	...
	RemoteEngineUpdate(context.Context, *RemoteEngineHealthRequest) (*RemoteEngineHealthResponse, error)
...
func (c *workflowAPIProtobufClient) RemoteEngineUpdate(ctx context.Context, in *RemoteEngineHealthRequest) (*RemoteEngineHealthResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "core")
	ctx = ctxsetters.WithServiceName(ctx, "WorkflowAPI")
	ctx = ctxsetters.WithMethodName(ctx, "RemoteEngineUpdate")
	out := new(RemoteEngineHealthResponse)
...
func (c *workflowAPIJSONClient) RemoteEngineUpdate(ctx context.Context, in *RemoteEngineHealthRequest) (*RemoteEngineHealthResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "core")
	ctx = ctxsetters.WithServiceName(ctx, "WorkflowAPI")
	ctx = ctxsetters.WithMethodName(ctx, "RemoteEngineUpdate")
	out := new(RemoteEngineHealthResponse)
...
func (s *workflowAPIServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	case "/twirp/core.WorkflowAPI/RemoteEngineHealthCheck":
		...
		return
	case "/twirp/core.WorkflowAPI/RemoteEngineUpdate":
		s.serveRemoteEngineUpdate(ctx, resp, req)
		return
...
func (s *workflowAPIServer) serveRemoteEngineUpdate(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveRemoteEngineUpdateJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveRemoteEngineUpdateProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *workflowAPIServer) serveRemoteEngineUpdateJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "RemoteEngineUpdate")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	func() {
		...
		respContent, err = s.WorkflowAPI.RemoteEngineUpdate(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *RemoteEngineHealthResponse and nil error while calling RemoteEngineUpdate. nil responses are not supported"))
		return
	}
...
func (s *workflowAPIServer) serveRemoteEngineUpdateProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "RemoteEngineUpdate")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
