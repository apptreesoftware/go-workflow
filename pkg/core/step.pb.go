...
func (*StepQueueWorkflowRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_step_34bfc74a06b53956, []int{0}
}
...
func (*StepQueueWorkflowResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_step_34bfc74a06b53956, []int{1}
}
...
func (*StepLogRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_step_34bfc74a06b53956, []int{2}
}
...
func (*StepOutput) Descriptor() ([]byte, []int) {
	return fileDescriptor_step_34bfc74a06b53956, []int{3}
}
...
func init() { proto.RegisterFile("step.proto", fileDescriptor_step_34bfc74a06b53956) }

var fileDescriptor_step_34bfc74a06b53956 = []byte{
